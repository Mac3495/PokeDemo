...
class __$$_DataCopyWithImpl<$Res>
    extends _$GetDataStateCopyWithImpl<$Res, _$_Data>
...
class _$_Data with DiagnosticableTreeMixin implements _Data {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GetDataState.data(data: $data)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'GetDataState.data'))
...
abstract class _Data implements GetDataState {
...
class __$$_ErrorCopyWithImpl<$Res>
    extends _$GetDataStateCopyWithImpl<$Res, _$_Error>
...
class _$_Error with DiagnosticableTreeMixin implements _Error {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GetDataState.error(error: $error)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GetDataState.error'))
...
abstract class _Error implements GetDataState {
...
class _$_Loading with DiagnosticableTreeMixin implements _Loading {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'GetDataState.loading'));
  }
